...
namespace AutoChat
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Console.WriteLine("AutoChat - Cargado");
            sayGreeting();
        ...
        static void setupMessages()
        {
            ...
            {
                "gj", "gj", "gj", "gj", "buena", "wp", "bien", "gj", "gjwp", "buena", "bien", "bien"
            };
            ...
            {
                "pusheen torres", "torres" , "limpien lineas", "push", "objetivos", "lineas", "push", "drake?"
            };
